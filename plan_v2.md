...
- No write to the board table without an identity; a write without a name is held in the browser, the page asks in
  words beside the name control, and the held edits are sent once a name is picked (Vatsal, 17 Sep 2026); test rows
  are keyed in data/board_ignore.json.
