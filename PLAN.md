...
- Open: spiff redeploys the Apps Script once so the v02_comments tab receives rows (docs/setup.html); the
  to-be-verified list and the three build gaps (G14 to G16, data/gaps.json v02 key) are on the Changelog tab.
